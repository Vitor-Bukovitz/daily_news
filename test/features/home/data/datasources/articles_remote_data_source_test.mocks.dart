...
// in daily_news/test/features/home/data/datasources/articles_remote_data_source_test.dart.
...
import 'package:daily_news/core/providers/config_providers.dart' as _i9;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockEnvironmentConfig extends _i1.Mock implements _i9.EnvironmentConfig {
  ...
  String get newsApiKey =>
      (super.noSuchMethod(Invocation.getter(#newsApiKey), returnValue: '')
          as String);
  @override
